...
public final class Settings {
    ...
    /**
     * Returns a boolean value for the key, defaults to false if not specified. This is equivalent to calling
     * {@link #getBooleanSetting(java.util.Map, String, Boolean)}.
     * 
     * @param settings
    ...
    /**
     * Gets a Boolean value for the key, returning the default value given if not specified or not a valid boolean
     * value.
     * 
     * @param settings
     * @param key the key to get the boolean setting for
     * @param defaultVal the default value to return if the setting was not specified or was not coercible to a Boolean
     *            value
    ...
    /**
     * Gets an Integer value for the key, returning the default value given if not specified or not a valid numeric
     * value.
     * 
     * @param settings
     * @param key the key to get the Integer setting for
     * @param defaultVal the default value to return if the setting was not specified or was not coercible to an Integer
     *            value
     ...
     */
    protected static int getIntSetting(Map<String, Object> settings, String key, int defaultVal)
