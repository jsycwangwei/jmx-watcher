package com.focustech.jmx.client;

import java.io.File;

public class JmxWatcherConfiguration {
    ...
    /**
     * If it is false, then JmxTrans will stop when one of the JSON configuration file is invalid. Otherwise, it will
     * just print an error and continue processing.
     *
    ...
    public void setConfigureFile(File configureFile) {
